...
namespace CLI
{
    public static class Upload
    {
        ...
        public static int DoUpload(UploadOptions options)
        {
            ...
            Console.WriteLine($"  Store ID: {options.StoreId}");
            ...
            try {
                ...
                ClientAPI.Ops.Upload(options.ServiceURL, options.Email, options.PAT, options.StoreId, options.Description, options.BuildId, files, uploadProgress);
