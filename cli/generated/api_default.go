...
*/
func (a *DefaultApiService) CreateTransaction(ctx _context.Context) ApiCreateTransactionRequest {
	return ApiCreateTransactionRequest{
		ApiService: a,
		ctx: ctx,
	}
...
*/
func (a *DefaultApiService) GetTransaction(ctx _context.Context, transactionId string) ApiGetTransactionRequest {
	return ApiGetTransactionRequest{
		ApiService: a,
		ctx: ctx,
