...
namespace Org.OpenAPITools.Api
{
    ...
    public partial class DefaultApi : IDefaultApi
    {
        ...
        {
            Org.OpenAPITools.Client.ApiResponse<UploadTransactionResponse> localVarResponse = CreateTransactionWithHttpInfo(uploadTransactionRequest);
        ...
        /// <param name="uploadTransactionRequest"></param>
        /// <returns>ApiResponse of UploadTransactionResponse</returns>
        public Org.OpenAPITools.Client.ApiResponse<UploadTransactionResponse> CreateTransactionWithHttpInfo(UploadTransactionRequest uploadTransactionRequest)
        {
            // verify the required parameter 'uploadTransactionRequest' is set
            if (uploadTransactionRequest == null)
                throw new Org.OpenAPITools.Client.ApiException(400, "Missing required parameter 'uploadTransactionRequest' when calling DefaultApi->CreateTransaction");
        ...
        {
            Org.OpenAPITools.Client.ApiResponse<UploadTransactionResponse> localVarResponse = await CreateTransactionWithHttpInfoAsync(uploadTransactionRequest, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (UploadTransactionResponse)</returns>
        public async System.Threading.Tasks.Task<Org.OpenAPITools.Client.ApiResponse<UploadTransactionResponse>> CreateTransactionWithHttpInfoAsync(UploadTransactionRequest uploadTransactionRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'uploadTransactionRequest' is set
            if (uploadTransactionRequest == null)
                throw new Org.OpenAPITools.Client.ApiException(400, "Missing required parameter 'uploadTransactionRequest' when calling DefaultApi->CreateTransaction");
        ...
        {
            Org.OpenAPITools.Client.ApiResponse<GetTransactionResponse> localVarResponse = GetTransactionWithHttpInfo(transactionId);
            return localVarResponse.Data;
        }
        ...
        /// <param name="transactionId">ID of the transaction to fetch</param>
        /// <returns>ApiResponse of GetTransactionResponse</returns>
        public Org.OpenAPITools.Client.ApiResponse<GetTransactionResponse> GetTransactionWithHttpInfo(string transactionId)
        {
            // verify the required parameter 'transactionId' is set
            if (transactionId == null)
                throw new Org.OpenAPITools.Client.ApiException(400, "Missing required parameter 'transactionId' when calling DefaultApi->GetTransaction");
        ...
        {
            Org.OpenAPITools.Client.ApiResponse<GetTransactionResponse> localVarResponse = await GetTransactionWithHttpInfoAsync(transactionId, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (GetTransactionResponse)</returns>
        public async System.Threading.Tasks.Task<Org.OpenAPITools.Client.ApiResponse<GetTransactionResponse>> GetTransactionWithHttpInfoAsync(string transactionId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'transactionId' is set
            if (transactionId == null)
                throw new Org.OpenAPITools.Client.ApiException(400, "Missing required parameter 'transactionId' when calling DefaultApi->GetTransaction");
