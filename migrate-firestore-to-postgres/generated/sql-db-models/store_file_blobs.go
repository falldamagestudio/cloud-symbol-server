...
// Exists checks if the StoreFileBlob row exists.
func (o *StoreFileBlob) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	return StoreFileBlobExists(ctx, exec, o.BlobID)
}
