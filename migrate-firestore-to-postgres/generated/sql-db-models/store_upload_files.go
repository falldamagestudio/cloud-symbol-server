...
// Exists checks if the StoreUploadFile row exists.
func (o *StoreUploadFile) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	return StoreUploadFileExists(ctx, exec, o.FileID)
}
