...
// Exists checks if the PersonalAccessToken row exists.
func (o *PersonalAccessToken) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	return PersonalAccessTokenExists(ctx, exec, o.PatID)
}
