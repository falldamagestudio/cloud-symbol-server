...
type DefaultApiRouter interface { 
	...
	GetStoreFileHashDownloadUrl(http.ResponseWriter, *http.Request)
	GetStoreFileHashes(http.ResponseWriter, *http.Request)
...
type DefaultApiServicer interface { 
	...
	GetStoreFileHashDownloadUrl(context.Context, string, string, string) (ImplResponse, error)
	GetStoreFileHashes(context.Context, string, string, int32, int32) (ImplResponse, error)
