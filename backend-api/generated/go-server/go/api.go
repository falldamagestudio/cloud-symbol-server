...
type DefaultApiServicer interface { 
	...
	GetStoreFileBlobs(context.Context, string, string, string, int32, int32) (ImplResponse, error)
	GetStoreFiles(context.Context, string, string, int32, int32) (ImplResponse, error)
	GetStoreUpload(context.Context, int32, string, string) (ImplResponse, error)
	GetStoreUploads(context.Context, string, string, int32, int32) (ImplResponse, error)
	GetStores(context.Context, string) (ImplResponse, error)
	GetToken(context.Context, string) (ImplResponse, error)
	GetTokens(context.Context, string) (ImplResponse, error)
