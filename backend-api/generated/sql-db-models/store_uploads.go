...
// Exists checks if the StoreUpload row exists.
func (o *StoreUpload) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	return StoreUploadExists(ctx, exec, o.UploadID)
}
