...
DROP TYPE cloud_symbol_server.store_file_blob_type;

DROP TABLE cloud_symbol_server.store_files;

DROP TABLE cloud_symbol_server.store_uploads;
DROP TYPE cloud_symbol_server.store_upload_status;

DROP TABLE cloud_symbol_server.stores;

DROP TABLE cloud_symbol_server.personal_access_tokens;
